              ...
              >
                ...
                <div className="container-app relative flex h-full items-center">
                  <div className="max-w-md py-8 sm:max-w-lg">
                    {slide.eyebrow && (
                      <span className="mb-3 inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-white ring-1 ring-white/30 backdrop-blur-[2px]">
                        {slide.eyebrow}
                      </span>
                    )}
                    <h2 className="font-display text-2xl font-bold leading-[1.15] text-white drop-shadow-sm sm:text-3xl lg:text-[2.6rem]">
                      {slide.heading}
                    </h2>
                    {slide.subheading && (
                      <p className="mt-3 max-w-md text-sm text-white/90 drop-shadow-sm sm:text-base">{slide.subheading}</p>
                    )}
